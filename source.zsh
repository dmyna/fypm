...
alias taduelss="_tadatels due all"
alias taals="_tadatels ALARM list"
alias taalss="_tadatels ALARM all"
alias taschls="_tadatels scheduled list"
alias taschlss="_tadatels scheduled all"
